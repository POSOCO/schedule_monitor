...
window.onload = function () {
    var headingsArray = getHeadingsList();
    ...
    var onBarHeadings = ["CGPL_DC_ONBAR", "GANDHAR-APM_DC_ONBAR", "GANDHAR-NAPM_DC_ONBAR", "KAWAS-APM_DC_ONBAR", "KAWAS-NAPM_DC_ONBAR",  "KSTPS-I&II_DC_ONBAR", "KSTPS7_DC_ONBAR", "MOUDA_DC_ONBAR", "MOUDA_II_DC_ONBAR", "NSPCL_DC_ONBAR", "RGPPL_IR_DC_ONBAR", "SASAN_DC_ONBAR", "SIPAT-I_DC_ONBAR", "SIPAT-II_DC_ONBAR", "VSTPS-I_DC_ONBAR", "VSTPS-II_DC_ONBAR", "VSTPS-III_DC_ONBAR", "VSTPS-IV_DC_ONBAR", "VSTPS-V_DC_ONBAR"];
    var schHeadings = ["CGPL_TOTAL", "GANDHAR-APM_TOTAL", "GANDHAR-NAPM_TOTAL", "KAWAS-APM_TOTAL", "KAWAS-NAPM_TOTAL", "KSTPS-I&II_TOTAL", "KSTPS7_TOTAL", "MOUDA_TOTAL", "MOUDA_II_TOTAL", "NSPCL_TOTAL", "RGPPL_IR_TOTAL", "SASAN_TOTAL", "SIPAT-I_TOTAL", "SIPAT-II_TOTAL", "VSTPS-I_TOTAL", "VSTPS-II_TOTAL", "VSTPS-III_TOTAL", "VSTPS-IV_TOTAL", "VSTPS-V_TOTAL"];
    var generatorNames = ["CGPL", "GANDHAR-APM", "GANDHAR-NAPM", "KAWAS-APM", "KAWAS-NAPM", "KSTPS-I&II", "KSTPS7", "MOUDA", "MOUDA_II", "NSPCL", "RGPPL_IR", "SASAN", "SIPAT-I", "SIPAT-II", "VSTPS-I", "VSTPS-II", "VSTPS-III", "VSTPS-IV", "VSTPS-V"];
    ...
    var revNumber = reservesArray_[headingsArray.indexOf("REVNO_MAX")][1];
    var stacksDiv = document.getElementById("reserveStacksDiv");
    var xLabels = [];
    for (var i = 0; i < 96; i++) {
        xLabels.push(i + 1);
    }
